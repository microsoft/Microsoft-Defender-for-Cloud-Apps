...
| select               |     ✓     | `/collection?$select='value' `                                   | Value can be: id, displayName, tags, riskScore, lastSeenDateTime, domains, userCount, ipAddressCount, transactionCount, uploadNetworkTraficInBytes, downloadNetworkTraficInBytes                                                                                                                                                                                                                                                                                                                 |
